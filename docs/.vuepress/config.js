    ...
    * */
    themeConfig: {
        ...
        * */
        ...
        //站点描述
        description: "欢迎来到天文馆，要一起来看星星吗？",

        //站点关键词，在后续版本中，还需优化 请使用英文状态下的逗号','隔开
        keyword: "vuepress主题,vuepress theme,生活琐事,二次元博客，樱本，樱本爱",
        ...
        * */
        about: [
            {
                ...
                describe: [
                    ...
                    "喜欢技术,coding",
                    "目前正在学习c++和搭建博客要学的东西",
                    '最喜欢的故事是主角没有抛弃任何一个队友的故事,梦想以后独居也能有一只猫猫',
                    "主题是我自己搬运借着教程慢慢魔改的，原作者是aurora<a href='https://aurora.xcye.xyz/' target='_blank'>Σ(￣□￣||)` ",
                    "有点拖延症",
                    "目前除了编程之外就是当个一个牌新了",
                    "正在追的番有《盾勇第二季》,《暗杀者贵族》,《只有我不在的街道》,《鬼灭之刃》,《关于我转生变成史莱姆这档事》...",
                    "看的漫画就有点杂了，不过我是纯纯的纯爱党。"
                ],
                tag: [
                    "coding",
                    "社恐",
            ...
            },
            {
                ...
                describe: [
                    "开发永不止步......",
                    "2021.12.10 -- 2022.3.11 懒狗终于开始开发了",
                ],
                tag: ['想求个star`(⌒▽⌒)`'],
                showTag: true,
            },
        ...
        poster: {
            ...
            avatar: "https://s9tu.com/images/2022/04/09/Vh3Z23.jpg",
        },
